        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center">
            <a href="#" className="flex items-center gap-3">
              <img src="./playbit-logo.png" alt="PlayBit Logo" className="h-10 w-10 object-contain" />
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="https://github.com/abhishekdewan101./issues/new" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-gray-300 hover:text-white uppercase tracking-wider transition-colors">Contact</a>
            <a 
      ...
      {isOpen && (
        <div className="md:hidden bg-game-dark border-b-2 border-game-border">
          <div className="px-2 pt-2 pb-6 space-y-2 sm:px-3">
            ...
            <a href="https://github.com/abhishekdewan101./issues/new" target="_blank" rel="noopener noreferrer" onClick={() => setIsOpen(false)} className="block px-3 py-4 text-base font-bold text-gray-300 hover:text-white hover:bg-game-card uppercase tracking-wider">Contact</a>
            <a 
              href="https://appdistribution.firebase.dev/i/67c96266be1b2f89" 
