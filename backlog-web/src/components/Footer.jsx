        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12 border-b-2 border-game-border pb-12">
          ...
          <div className="md:col-span-2">
            <a href="#" className="flex items-center gap-3 mb-6">
              <img src="/PlayBit/playbit-logo.png" alt="PlayBit Logo" className="h-10 w-10 object-contain grayscale" />
          ...
          <div>
            ...
            <ul className="space-y-4 font-bold text-gray-500 uppercase tracking-wide">
              ...
              <li><a href="https://github.com/abhishekdewan101/PlayBit/issues/new" target="_blank" rel="noopener noreferrer" className="hover:text-game-neon transition-colors">Contact / Report Issue</a></li>
            </ul>
          </div>
